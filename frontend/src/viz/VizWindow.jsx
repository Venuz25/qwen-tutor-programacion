...
// Componente modal que renderiza y controla la reproducción de visualizaciones de algoritmos.
const VizWindow = ({ payload: initialPayload, onClose }) => {
  ...
  useEffect(() => {
    try {
      const generatedSteps = generateVizSteps(payload);
  ...
  // Genera un nuevo conjunto de datos aleatorios según la categoría del algoritmo.
  const randomize = () => {
  ...
  // Aplica los parámetros personalizados introducidos por el usuario en formato JSON.
