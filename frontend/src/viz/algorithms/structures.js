export const STRUCTURE_ALGORITHMS = {
  stack_ops: {
    ...
    generateSteps({ operations }) {
      const steps = [];
      const stack = [];
      steps.push({ type: 'stack', data: [...stack], description: 'Pila inicial vacía', highlight: null });
  ...
  queue_ops: {
    ...
    generateSteps({ operations }) {
      const steps = [];
      const queue = [];
      steps.push({ type: 'queue', data: [...queue], description: 'Cola inicial vacía', highlight: null });
  ...
  linked_list_ops: {
    ...
    generateSteps({ operations }) {
      const steps = [];
      const list = [];
      steps.push({ type: 'll', data: [...list], description: 'Lista inicial vacía (Head -> null)', highlight: null, ptr: null });
